...
interface SidebarProps extends React.ComponentProps<"div"> {
  ...
  /** Screen-reader title for the mobile sheet; visually hidden but required for a11y. */
  mobileTitle?: string;
  mobileDescription?: string;
}

/**
 * Ports shadcn's sidebar, adapted to reno's `--sidebar*` tokens. Renders a
 * `Sheet` below the mobile breakpoint and a fixed, width-animated column above
 * it. Menu items take `asChild` rather than assuming a router.
 */
export function Sidebar({
  ...
  mobileDescription = "Danh sách điều hướng chính",
  className,
  children,
  ...props
}: SidebarProps) {
